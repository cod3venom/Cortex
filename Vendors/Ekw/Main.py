...
from Vendors.Ekw.EKW_report_downloader import  Report_downloader
...
class EkwAuth:
    ...
    def GetOptions(self):
        self.Options = self.__restClient.getEkwBotOptions(self.__options_id)
        self.Javascript = self.__restClient.getJavascript(self.Options.ARG_CUSTOM_JAVASCRIPT_ID)
        self.EkwNumbers = self.__restClient.getEkwNumbers(self.Options.EKW_ID)
        self.Start()
